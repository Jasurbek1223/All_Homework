...
//foreach (var groupj in groupJoin)
//{
//    Console.WriteLine($"Customer: {groupj.cus.FirstName} {groupj.cus.LastName}");
//    foreach (var groupk in groupj.ord)
//    {
//        Console.WriteLine($"Id {groupk.Id}, Amaunt {groupk.Amount}, CustomerId {groupk.CustomerId}, Date {groupk.OrderDate}");
//    }
//}
...
var groupByContries = groupJoin.GroupBy(c => c.cus.Country).ToList();

//foreach (var group in groupByContries)
//{
//    Console.WriteLine("Davlat: " + group.Key);
//    foreach (var cust in group)
//    {
//        Console.WriteLine($"CustomerName: {cust.cus.LastName} {cust.cus.FirstName}");
//    }
//}


//-country lar ichidan UK tanlash - where
var countryUK = groupJoin.Where(c => c.cus.Country == Country.UK).ToList();

//Console.WriteLine("UK dan bo'lgan odamlar:");

//foreach (var member in countryUK)
//{
//    Console.WriteLine($"{member.cus.FirstName} {member.cus.LastName}");
//}
